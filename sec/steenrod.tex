...
\Guillaume{Introduce zonotopes before, or remove the following example}
...
In the case where the normal fan of $D_P$ is already an hyperplane arrangement (for example, when $D_P$ is a zonotope, or when $P$ is a zonotope \Guillaume{introduce zonotopes}), it then agrees with the fundamental hyperplane arrangement of $P$.
...
\Guillaume{Could this statement be useful to something?}
\begin{theorem}
