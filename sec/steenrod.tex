...
\begin{example}
	...
	\Guillaume{TBC; + add general links with the fundamental hyperplane arrangement!!}
\end{example}
...
\begin{lemma}
	The polytope of diagonals $D_{\Delta^n}$ of the standard $n$-simplexe is the $n$-dimensional permutahedron. 
\end{lemma}
